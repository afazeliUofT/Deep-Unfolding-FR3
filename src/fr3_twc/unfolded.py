...
RR_MODES = {"rate_recovered_primal_dual", "rate_recovered", "rr_primal_dual"}
...
class RateRecoveredPrimalDualUnfolded(BudgetAwarePrimalDualUnfolded):
    """Budget-aware student trained for post-repair rate recovery."""

    algorithm_name = "rate_recovered_primal_dual_unfolded"
...
def train_unfolded_model(cfg: Any) -> Tuple[tf.keras.Model, tf.keras.optimizers.Optimizer]:
    ...
    if mode in FR_MODES:
        ...
        model = RateRecoveredPrimalDualUnfolded(cfg)
