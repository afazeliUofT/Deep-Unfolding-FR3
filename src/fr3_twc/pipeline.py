...
from .unfolded import FR_MODES, PD_MODES, train_unfolded_model, unfolded_inference, unfolded_mode
...
def _should_distill(cfg: Any, epoch: int, global_step: int) -> bool:
    if unfolded_mode(cfg) not in PD_MODES and unfolded_mode(cfg) not in FR_MODES:
        return False
